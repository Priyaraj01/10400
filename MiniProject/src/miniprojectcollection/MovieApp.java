...
public class MovieApp 
{
	...
	{   		
		...
		for(Movie m:MovieList)
		{
				...
				System.out.println("Movie ID:"+m.getMovieID()+"\t Movie Name:"+m.getMovieName()+"\t Actor Name:"+m.getActorName()+"\t TicketPrice:"+m.getTicketPrice()+"\t Director Name:"+m.getDirectorName());
	...
	public void AddMovieInfo() 
	{
		...
		Movie m=new Movie(MovieId, MovieName, ActorName, ActoressName, DirectorName,TicketPrice);
	...
	public void UpdateTicketPriceById()
	{
		System.out.println("Enter Movie Id:");
		int MovieID=sc.nextInt();
	    int flag=0,index = 0;
	    ...
	    {
	    	if(Ticket.getMovieID()==MovieID)//101==101
	    	{
	    		flag=1;
